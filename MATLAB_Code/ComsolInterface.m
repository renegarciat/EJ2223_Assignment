classdef ComsolInterface < handle
   ...
   methods
      ...
      function drawRotorSector(obj, geometry)
         ...
         [obj.leftMagnetPoints, obj.rightMagnetPoints, obj.tipPocketPoints] = draw_rotor_sector(obj.model, obj.geomTag, ...
                 g.RotorAngle_rad, ...
      ...
      function createSelections(obj, geometry)
         ...
         if isempty(obj.leftMagnetPoints) || isempty(obj.rightMagnetPoints) || isempty(obj.tipPocketPoints)
